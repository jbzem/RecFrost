...
<title>Privacy Policy — RecFrost</title>
<meta name="description" content="What RecFrost collects, why, and how to have your data deleted." />
...
<main>
	...
	<p class="lede">
		RecFrost is a free, open source, fan-run game server. It is not a business, it sells
	...
	<h2>Who runs this</h2>
	<p>
		RecFrost is maintained by a volunteer community, and its source code is public at
		<a href="${SOURCE_REPO}" target="_blank" rel="noreferrer">github.com/djdevin/recflare</a>.
		This policy covers the RecFrost game servers and this website. It is a fan project, not
	...
	<p>
		...
		below is handled, and anyone can run their own separate copy of RecFrost. This policy
	...
	<ul>
		...
		<li><strong>Meta, when you sign in with a Meta account.</strong> We send Meta the sign-in token from your headset so it can be verified, which tells Meta that a RecFrost sign-in took place. That exchange is governed by Meta's own privacy policy. Signing in with Steam involves no such call.</li>
	...
	${contactList()}
	<p>
		Tell us your RecFrost username, and be ready to prove the account is yours — normally
	...
	<h2>Children</h2>
	<p>
		RecFrost is not directed at children under 13, and we don't knowingly collect data from
...
<footer>
	<a href="/">RecFrost</a> — a fan project, not affiliated with Rec Room Inc.
</footer>
</body>
</html>`
}
